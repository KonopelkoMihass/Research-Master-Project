...
public:
	...
	/// Creates a projectile from the pool of available projectiles. If no projectiles are available, the next 
	///  in (pool) sequence after the last used projectile is chosen.
	/// </summary>
	...
	/// Sets an index to the next available projectile. Also sets a status flag to indicate pool full (all projectiles in use).
	/// </summary>
